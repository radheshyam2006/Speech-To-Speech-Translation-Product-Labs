...
class FastAPIApp:
    ...
    def __init__(self):
        self.app = FastAPI()
        self.input_queue = 'TTS_output'
        self.output_queue = 'Buffer'
        self.message_processor = BufferMessageProcessor(
    ...
    async def log_message(self, log_msg: str, level: str = "INFO"):
        """Logs messages using the BufferMessageProcessor's log_message method."""
