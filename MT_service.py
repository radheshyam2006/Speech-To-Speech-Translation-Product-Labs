...
class FastAPIApp:
    ...
    def __init__(self):
        self.app = FastAPI()
        self.input_queue = 'MT_input'
        self.output_queue = 'MT_output'
        self.message_processor = MTMessageProcessor(
    ...
    async def log_message(self, log_msg: str, level: str = "INFO"):
        """Logs messages using the MTMessageProcessor's log_message method."""
